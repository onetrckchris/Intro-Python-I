...
# YOUR CODE HERE
print("Current working directory: ", os.getcwd()) # Returns the path to the working directory

# Print out your machine's login name
# YOUR CODE HERE
print("Currently logged in user: ", os.getlogin())
